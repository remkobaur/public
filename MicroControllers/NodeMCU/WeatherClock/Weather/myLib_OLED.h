...
void writeOled(int row,int leftMargin,String S){
  u8g2.setFont(u8g2_font_6x10_tf);
  u8g2.drawStr(leftMargin,row*10,S.c_str());
  
}

void OLED_write(int x,int y,int fsize,String S){
  //https://github.com/olikraus/u8g2/wiki/fntlistall
  switch(fsize){
    case 1: u8g2.setFont(u8g2_font_6x10_tf);break;
    case 2: u8g2.setFont(u8g2_font_7x13_tf);break; // u8g2_font_7x13_tf u8g2_font_8x13B_tf
    case 3: u8g2.setFont(u8g2_font_crox3hb_tf);break;
    case 4: u8g2.setFont(u8g2_font_timR10_tr);break;
    case 5: u8g2.setFont(u8g2_font_profont17_mr);break;
    case 6: u8g2.setFont(u8g2_font_bubble_tn);break;
    case 7: u8g2.setFont(u8g2_font_osb29_tn);break; //u8g2_font_osb21_tn u8g2_font_timB24_tn  u8g2_font_freedoomr25_mn 
    }
...
void OLED_Demo3(){
 String  S1 = get_Str_Time()+"   "+get_Str_Date();
u8g2.firstPage();
do {
  writeOled(1,0,S1);
  writeOled(2,0,"123456789012345678901234567890");
  writeOled(3,0,"Aktuelles Wetter:  Solala");
 } while ( u8g2.nextPage() );   
